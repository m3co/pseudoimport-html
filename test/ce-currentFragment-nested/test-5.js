...
promise_test(function() { return new Promise(this.step_func((resolve, reject) => {
  ...
  fragment1.id = 'test-5-1';
  fragment2.id = 'test-5-2';

  fragment1.setAttribute('src', 'ce-currentFragment-nested/test-5-1.html');
  fragment2.setAttribute('src', 'ce-currentFragment-nested/test-5-2.html');
...
test(() => {
  assert_equals(document.currentFragment, document.querySelector('#test-5'));
